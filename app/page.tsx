...
export default function HomePage() {
  return (
    <main>
      ...
      <section className="partners section" id="customers" data-pickrun-id="partners-section"><div className="tag">IDEAL PARTNERS</div><h2>Built for the brands<br/><i>shaping plant-based nutrition</i></h2><div className="partnerTypes"><span>Nutraceutical Brands</span><span>Ayurvedic Companies</span><span>Health Food Brands</span><span>Functional Beverage Makers</span><span>Exporters</span></div><div className="partnerCards"><div><b>Long-Term Supply Agreements</b><p>Predictable volume and pricing for both sides.</p></div><div><b>Bulk Sales</b><p>Standard 20–25 kg bags sized for production use.</p></div><div><b>Premium Quality</b><p>For consistent, verified quality your team can trust.</p></div><div><b>Value-Added Ingredients</b><p>Expanding beyond powder as demand grows.</p></div></div></section>
